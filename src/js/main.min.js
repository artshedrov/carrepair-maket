...
var VideoTab = /*#__PURE__*/function () {
  function VideoTab(props) {
    _classCallCheck(this, VideoTab);
  ...
  _createClass(VideoTab, [{
    key: "initFindVideoTab",
    value: function initFindVideoTab() {
      var videos = document.querySelectorAll(this.config.videoTabAttribute);
    ...
    key: "setupVideoTab",
    value: function setupVideoTab(video) {
      var _this = this;

      var link = video.querySelector(this.config.videoLinkAttribute);
      var button = video.querySelector(this.config.playButtonAttribute);
      video.addEventListener('click', function () {
        var media = video.querySelector(_this.config.tabMediaAttribute);

        var id = _this.parseMediaURLTab(media);

        var iframe = _this.createIframeTab(id);
    ...
    key: "parseMediaURLTab",
    value: function parseMediaURLTab(media) {
    ...
    key: "createIframeTab",
    value: function createIframeTab(id) {
    ...
    key: "generateURLTab",
    value: function generateURLTab(id) {
...
var VideoBlock = /*#__PURE__*/function () {
  ...
  _createClass(VideoBlock, [{
    key: "initFindVideo",
    value: function initFindVideo() {
      var videos = document.querySelectorAll(this.config.videoBlock);
    ...
    value: function setupVideo(video) {
      ...
      var link = video.querySelector(this.config.videoLink);
      var button = video.querySelector(this.config.playButton);
      var title = video.querySelector(this.config.titleVideoBlock);
      video.addEventListener('click', function () {
        var link = video.querySelector(_this.config.videoLink); // let media = video.querySelector(this.config.tabMediaAttribute);

        var media = link;

        var id = _this.parseMediaURL(media);
...
var Modal = /*#__PURE__*/function () {
  ...
  function Modal(props) {
     ...
     */
    var defaultConfig = {
      linkAttributeName: 'data-modal' // ... здесь остальные свойства

    };
    this.config = Object.assign(defaultConfig, props); // сразу вызываем метод инициализации
  ...
  _createClass(Modal, [{
    ...
    value: function init() {
      ...
      document.addEventListener("click", function (e) {
        var wrap = e.target.classList.contains('modal__shadow--show');
        if (!wrap) return;
        e.preventDefault();
        this.close();
      }.bind(this)); // Создаём только одну подложку и вставляем её в конец body
    ...
    value: function close() {
      ...
      this.openedWindow.setAttribute('aria-hidden', 'true'); //возвращаем фокус на элемент которым открылось окно
      //this.focusContol();
      //возвращаем скролл
...
_defineProperty(Modal, "_shadow", false);
var wow = new WOW({
  boxClass: 'wow',
...
var videoIframe = new VideoBlock({
  videoBlock: '.video__block',
  videoLink: '.video__link',
  titleVideoBlock: '.video__header',
  playButton: '.video__button'
});
var tabVideo = new VideoTab({
  videoTabAttribute: '.tab__video',
  videoLinkAttribute: '.video__link',
  tabMediaAttribute: '.video__img',
  playButtonAttribute: '.play-button'
